public class MigrationSimulator {
    ...
    public int[] getBirdBearCount(Site site) throws IllegalAnimalException {
        ...
        for (Animal animal : site.getAnimals()) {
            status = animal.getStatus();
            if (animal instanceof Bird && status.equals("ALIVE")) {
                cbird++;
            }
            else if (animal instanceof Bear && status.equals("ALIVE")) {
                cbear++;
            }
            else {
    ...
    public static void main(String[] args) {
        ...
        new MigrationSimulator(10, 1000, 1000);
